...
btnEnviar.addEventListener('click', async ()=>{
    ...
    if (radio2moral.checked || radio3gobierno.checked || radio5.checked) {
        ...
        if (numsByExcelFile.value === "") {
            ...
            if(!(numsByExcelFile.files[0].type === 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' || extensionFileXlsm === 'xlsm' || extensionFileXlsm === 'xlsx'  || extensionFileXlsm === 'xls')){
                Swal.fire({
                    icon: 'error',
                    //title: 'Oops...',
                    text: 'Something went wrong!',
